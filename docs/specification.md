...
**Project name:** Agsmobile
**Project type:** Interactive agricultural mobile application (Android and iOS)

**Overall objective:**
To create a digital platform that connects stakeholders in the Senegalese agricultural sector (producers, technicians, researchers, investors, and job seekers) through an interactive map, personalized agronomic advice, and an agricultural jobs database.
...
### B. “Personalized Agricultural Advice” Section
...
### C. “Agricultural Employment” Section

**Objective:**
To connect agricultural job seekers with farms and companies looking for labor.
...
9. Desired position (farm worker, technician, driver, production manager, etc.)
10. Salary expectations

After submission, the application is stored in the database and made visible to authorized recruiters.

Farms can also publish job offers (job title, required profile, contract type, proposed salary, etc.).
...
## 4. Agricultural Training Component

Enable anyone (farmer, student, technician, or enthusiast) to easily learn good agricultural practices according to specific crops.
